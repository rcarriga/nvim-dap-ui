...
---
--- It is highly recommended to use lazydev.nvim(https://github.com/folke/lazydev.nvim)
--- to enable type checking for nvim-dap-ui to get type checking, documentation, and
--- autocompletion for all API functions.
--- 
--- ```lua
