...
---@async
function LSPNotifyClient.exit() end
...
---@field serverInfo? dapui.async.lsp.types.Structure0 Information about the server.  @since 3.15.0
...
---@field location dapui.async.lsp.types.Location|dapui.async.lsp.types.Structure3 The location of the symbol. Whether a server is allowed to return a location without a range depends on the client capability `workspace.symbol.resolveSupport`.  See SymbolInformation#location for more details.
...
---@class dapui.async.lsp.types.DocumentOnTypeFormattingParams
---@field textDocument dapui.async.lsp.types.TextDocumentIdentifier The document to format.
---@field position dapui.async.lsp.types.Position The position around which the on type formatting should happen. This is not necessarily the exact position where the character denoted by the property `ch` got typed.
...
---@field options dapui.async.lsp.types.FormattingOptions The formatting options.
...
---
--- @since 3.16.0
---@class dapui.async.lsp.types.ChangeAnnotation
...
---@field cells? dapui.async.lsp.types.Structure6 Changes to cells
...
---@field clientInfo? dapui.async.lsp.types.Structure7 Information about the client  @since 3.15.0
...
---@field workspace? dapui.async.lsp.types.Structure8 Workspace specific server capabilities.
...
---@field completionItem? dapui.async.lsp.types.Structure9 The server supports the following `CompletionItem` specific capabilities.  @since 3.17.0
...
---@field notebookSelector dapui.async.lsp.types.Structure10|dapui.async.lsp.types.Structure11[] The notebooks to be synced
...
---@field staleRequestSupport? dapui.async.lsp.types.Structure12 Client capability that signals how the client handles stale requests (e.g. a request for which the client will not process the response anymore since the information is outdated).  @since 3.17.0
...
---@field changeAnnotationSupport? dapui.async.lsp.types.Structure13 Whether the client in general supports change annotations on text edits, create file, rename file and delete file changes.  @since 3.16.0
...
---@field symbolKind? dapui.async.lsp.types.Structure14 Specific capabilities for the `SymbolKind` in the `workspace/symbol` request.
---@field tagSupport? dapui.async.lsp.types.Structure15 The client supports tags on `SymbolInformation`. Clients supporting tags have to handle unknown tags gracefully.  @since 3.16.0
---@field resolveSupport? dapui.async.lsp.types.Structure16 The client support partial workspace symbols. The client will send the request `workspaceSymbol/resolve` to the server to resolve additional properties.  @since 3.17.0
...
---@field completionItem? dapui.async.lsp.types.Structure17 The client supports the following `CompletionItem` specific capabilities.
---@field completionItemKind? dapui.async.lsp.types.Structure18
...
---@field completionList? dapui.async.lsp.types.Structure19 The client supports the following `CompletionList` specific capabilities.  @since 3.17.0
...
---@field signatureInformation? dapui.async.lsp.types.Structure20 The client supports the following `SignatureInformation` specific properties.
...
---@field symbolKind? dapui.async.lsp.types.Structure21 Specific capabilities for the `SymbolKind` in the `textDocument/documentSymbol` request.
---@field hierarchicalDocumentSymbolSupport? boolean The client supports hierarchical document symbols.
---@field tagSupport? dapui.async.lsp.types.Structure22 The client supports tags on `SymbolInformation`. Tags are supported on `DocumentSymbol` if `hierarchicalDocumentSymbolSupport` is set to true. Clients supporting tags have to handle unknown tags gracefully.  @since 3.16.0
...
---@field codeActionLiteralSupport? dapui.async.lsp.types.Structure23 The client support code action literals of type `CodeAction` as a valid response of the `textDocument/codeAction` request. If the property is not set the request can only return `Command` literals.  @since 3.8.0
...
---@field resolveSupport? dapui.async.lsp.types.Structure24 Whether the client supports resolving additional code action properties via a separate `codeAction/resolve` request.  @since 3.16.0
...
---@field foldingRangeKind? dapui.async.lsp.types.Structure25 Specific options for the folding range kind.  @since 3.17.0
---@field foldingRange? dapui.async.lsp.types.Structure26 Specific options for the folding range.  @since 3.17.0
...
---@field tagSupport? dapui.async.lsp.types.Structure27 Client supports the tag property to provide meta data about a diagnostic. Clients supporting tags have to handle unknown tags gracefully.  @since 3.15.0
...
---@field resolveSupport? dapui.async.lsp.types.Structure29 Indicates which properties a client can resolve lazily on an inlay hint.
...
---@field messageActionItem? dapui.async.lsp.types.Structure30 Capabilities specific to the `MessageActionItem` type.
...
---
--- @since 3.16.0
---@class dapui.async.lsp.types.MarkdownClientCapabilities
...
---@alias dapui.async.lsp.types.PrepareRenameResult dapui.async.lsp.types.Range|dapui.async.lsp.types.Structure31|dapui.async.lsp.types.Structure32
...
---@alias dapui.async.lsp.types.TextDocumentContentChangeEvent dapui.async.lsp.types.Structure33|dapui.async.lsp.types.Structure34
---@alias dapui.async.lsp.types.MarkedString string|dapui.async.lsp.types.Structure35
...
---@alias dapui.async.lsp.types.TextDocumentFilter dapui.async.lsp.types.Structure36|dapui.async.lsp.types.Structure37|dapui.async.lsp.types.Structure38
---@alias dapui.async.lsp.types.NotebookDocumentFilter dapui.async.lsp.types.Structure39|dapui.async.lsp.types.Structure40|dapui.async.lsp.types.Structure41
...
---@field editRange? dapui.async.lsp.types.Range|dapui.async.lsp.types.Structure42 A default edit range.  @since 3.17.0
...
---@field structure? dapui.async.lsp.types.Structure43 Changes to the cell structure to add or remove cells.
...
---@field textContent? dapui.async.lsp.types.Structure44[] Changes to the text content of notebook cells.
...
---@field cells? dapui.async.lsp.types.Structure45[] The cells of the matching notebook to be synced.

---@class dapui.async.lsp.types.Structure11
---@field notebook? string|dapui.async.lsp.types.NotebookDocumentFilter The notebook to be synced If a string value is provided it matches against the notebook type. '*' matches every notebook.
---@field cells dapui.async.lsp.types.Structure46[] The cells of the matching notebook to be synced.
...
---@field tagSupport? dapui.async.lsp.types.Structure47 Client supports the tag property on a completion item. Clients supporting tags have to handle unknown tags gracefully. Clients especially need to preserve unknown tags when sending a completion item back to the server in a resolve call.  @since 3.15.0
...
---@field resolveSupport? dapui.async.lsp.types.Structure48 Indicates which properties a client can resolve lazily on a completion item. Before version 3.16.0 only the predefined properties `documentation` and `details` could be resolved lazily.  @since 3.16.0
---@field insertTextModeSupport? dapui.async.lsp.types.Structure49 The client supports the `insertTextMode` property on a completion item to override the whitespace handling mode as defined by the client (see `insertTextMode`).  @since 3.16.0
...
---@field documentationFormat? dapui.async.lsp.types.MarkupKind[] Client supports the following content formats for the documentation property. The order describes the preferred format of the client.
---@field parameterInformation? dapui.async.lsp.types.Structure50 Client capabilities specific to parameter information.
...
---@field codeActionKind dapui.async.lsp.types.Structure51 The code action kind is support with the following value set.
...
---@field range? boolean|dapui.async.lsp.types.Structure52 The client will send the `textDocument/semanticTokens/range` request if the server provides a corresponding handler.
---@field full? boolean|dapui.async.lsp.types.Structure53 The client will send the `textDocument/semanticTokens/full` request if the server provides a corresponding handler.
...
---@field valueSet dapui.async.lsp.types.CompletionItemTag[] The tags supported by the client.

---@class dapui.async.lsp.types.Structure48
---@field properties string[] The properties that a client can resolve lazily.
...
---@field labelOffsetSupport? boolean The client supports processing label offsets instead of a simple label string.  @since 3.14.0

---@class dapui.async.lsp.types.Structure51
...
---@class dapui.async.lsp.types.Structure52

---@class dapui.async.lsp.types.Structure53
